"""
URL configuration for tic_tac_toe_backend project.
...
from games.views import RegisterView, LoginView, make_move
from games.views import StartGameView, match_history,UpdateUserProfileView
